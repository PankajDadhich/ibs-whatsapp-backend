                ...
                if (data.plan_name.toLowerCase() !== 'free') {
                    ...
                    if (subscriptionResult.rows.length > 0) {
                        ...
                        if (invoiceResult.rows.length > 0) {
                            ...
                            let body = `<html><body><p>Dear${' ' + data.firstname + ' ' + data.lastname},</p><p>We hope you have enjoyed your subscription to <b>Whatsapp Bulkify</b>! We wanted to remind you that your current subscription will expire on ${moment(data.end_date).format('DD-MM-YYYY')}.</p><p>To ensure uninterrupted access to all the features and benefits of <b>Whatsapp Bulkify</b>, we recommend renewing your subscription as soon as possible.</p><p>Best regards,</p></body></html>`;
                    ...
                    if((await companyQry).rows.length > 0){
                        ...
                        if(userQry.rows.length > 0){
                            ...
                            let body = `<html><body><p>Dear${' ' + data.firstname + ' ' + data.lastname},</p><p>We hope you've enjoyed your free subscription to <b>Whatsapp Bulkify</b>!</p><p>We wanted to let you know that your free subscription plan will expire on ${moment(data.end_date).format('DD-MM-YYYY')}. To continue enjoying all the great features and benefits of <b>Whatsapp Bulkify</b>, you can upgrade to one of our premium plans.</p><p>Best regards</p></body></html>`;
